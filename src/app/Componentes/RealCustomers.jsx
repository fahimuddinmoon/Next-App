...
export default function RealCustomers() {
    return (
        <div className="relative py-12 bg-[#0b0e0b] text-center text-white">
            ...
            <h2 className='text-2xl md:text-3xl lg:text-5xl font-bold mt-10 mb-5'>Ready to Turn Visitors Into  <br />  <span className='text-[#1FFFA5]'>Real Customers?</span></h2>
            ...
            <div className='border-[#2A3C36]  bg-[#192420]  rounded-lg p-6 border mx-[20px] md:mx-[120px] lg:mx-[470px] mt-10'>
            ...
            <div className='flex justify-between mx-6 md:mx-40 lg:mx-[495px] flex-wrap gap-7 mt-2 pb-12 text-xs'>
