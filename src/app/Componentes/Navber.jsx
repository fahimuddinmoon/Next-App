    ...
    return (
        <div className=" text-white text-center pt-6 pb-20 bg-[radial-gradient(ellipse_80%_80%_at_top,_#0f3d2e_0%,_#0a1a12_40%,_#121a14_100%)]">
            <motion.img
                ...
                className='mx-auto' src="Image/white-Logos.png" alt="" />
            <motion.p
                initial={{ opacity: 0, y: 80 }}
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true, amount: 0.2 }}
                transition={{ duration: 0.6 }}
                className='text-xs sm:text-sm flex justify-center items-center mt-16 border-t-2 border-[#1FFFA5] py-2 px-4 bg-[#192420] rounded-full mx-[50px] lg:mx-[520px] md:mx-[170px]'>
            ...
            >
                <h2
                    className='text-2xl md:text-4xl lg:text-5xl font-bold mt-10 mb-5'>Strategic Landing <br className='hidden md:inline lg:hidden' /> Pages That <br className='hidden lg:inline' /> Convert <br className='hidden md:inline lg:hidden' />From Just <span className='text-[#1FFFA5]'>$200</span>
                </h2>
            ...
            >
                ...
                <div className='flex justify-between mx-6 md:mx-40 lg:mx-[495px] flex-wrap gap-7 mt-2 text-xs'>
                    <p className='text-gray-500  flex justify-center items-center gap-1'><MdLockOutline /> SSL secure</p>
                    <p className='text-gray-500  flex justify-center items-center gap-1'><FaCheck /> Money-back guaranteed</p>
                    <p className='text-gray-500  flex justify-center items-center gap-1'><IoIosStar /> Satisfaction guaranteed</p>
                </div>
            </motion.div>
        </div>
    )
