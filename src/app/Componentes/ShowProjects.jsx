                ...
                <div className='sm:hidden inline py-8'>
                    <div className=' bg-[#151E1B] rounded-lg m-5 pb-4'>
                        ...
                        <div className='px-6 '>
                            ...
                            <div className='text-gray-400'>
                                <p className='text-xs px-3 mt-2 rounded-2xl flex mr-10 justify-start items-center gap-2 bg-[#003D25] py-2'>
                                    <span className='text-[#1FFFA5]'>
                                        <FaCheck />
                                    </span>
                                    20% high conversion than average in first week
                                </p>
                                <p className=' flex justify-start mt-2 items-center gap-2 text-xs px-3 rounded-2xl bg-[#003D25] py-2  mr-16 text-end'>
                                    <span className='text-[#1FFFA5]'>
                                        <FaCheck />
                                    </span>
                                    Clean and modern design with clear CTA
                    ...
                    <div className=' bg-[#151E1B] rounded-lg m-5 pb-4'>
                        ...
                        <div className='px-6 '>
                            ...
                            <div className='text-gray-400'>
                                <p className='text-xs px-3 mt-2 rounded-2xl flex justify-start items-center gap-2 mr-10 bg-[#003D25] py-2'>
                                    <span className='text-[#1FFFA5]'>
                                        <FaCheck />
                                    </span>
                                    20% high conversion than average in first week
                                </p>
                                <p className=' flex justify-start mt-2 items-center gap-2 text-xs px-3 mr-16 rounded-2xl bg-[#003D25] py-2  text-end'>
                                    <span className='text-[#1FFFA5]'>
                                        <FaCheck />
                                    </span>
                                    Clean and modern design with clear CTA
